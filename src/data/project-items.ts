...
export const projectItems: ProjectItem[] = [
  ...
  {
    id: 'self-media-group',
    slug: 'ai-self-media-group',
    title: 'AI自媒体群项目',
    categoryEmoji: '🎬',
    category: '内容矩阵',
    tagColor: 'bg-rose-50 text-rose-600',
    desc: 'AI 智能生成图文/短视频，矩阵化运营多平台自媒体账号群，快速起号 + 流量变现。',
    level: 'flow',
    recommend: true,
    highlights: [
      'AI 一键生成图文 / 短视频脚本',
    ...
    forWho: '有表达欲但不想真人出镜，想做矩阵化内容创业的内容创作者',
    sop: [
      { title: '第 1 周 · 选垂类', desc: '锁定 1 个内容垂类 + 人设' },
      { title: '第 2 周 · 矩阵规划', desc: 'AI 生成 30 天选题库 + 多账号定位' },
      { title: '第 3 周 · 内容生产', desc: 'AI 批量生成图文/口播视频，多账号同步发布' },
      { title: '第 4 周 · 矩阵放大', desc: '3 平台 × 5 账号矩阵 + 流量主 + 商单接入' },
    ],
    roleSupport: ['executor', 'partner', 'manager'],
    startChecklist: ['锁定 1 个内容垂类', '规划 30 天选题', '搭建 5-10 个账号矩阵', '接入流量主 + 商单通道'],
  },
  {
    id: 'tool-promotion',

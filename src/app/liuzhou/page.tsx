...
// ─── 柳州站静态首页（与深圳首页结构一致，仅替换城市文案与右侧主理人头像）───

// 柳州站活动数据：静态 3 条示例，不依赖 API
const LiuzhouStaticActivities: Activity[] = [
  { id: 'w1', city: '柳州', user: '王主理人', action: '发布了新工具测评', createdAt: '2小时前' },
  { id: 'w2', city: '柳州', user: '李同学', action: '加入了 OPC 智富社群', createdAt: '4小时前' },
  { id: 'w3', city: '柳州', user: '张老板', action: '完成了 AI 选品陪跑', createdAt: '1天前' },
]

// 柳州站主理人卡片：直接用 fallback，不 fetch
const LiuzhouBentoItems: BentoItem[] = fallbackBentoItems.map((item, idx) =>
  idx === 0
    ? {
        ...item,
        title: 'OPC 城市主理人生态圈',
        description: '全国 7 座城市已联动（含柳州），招募更多城市合伙人共拓 AI 市场',
      }
    : item,
)

export default function LiuzhouHomePage() {
  return (
    <ClientLayout>
      <div className="min-h-screen bg-slate-50">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 pt-16 pb-24 px-5">
          ...
          <div className="relative max-w-lg mx-auto md:max-w-6xl md:mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-center md:text-left">
                ...
                >
                  ...
                  <span className="text-sm text-amber-100 font-semibold tracking-wide">
                    良朋社<span className="text-amber-300">OPC</span> 智富生态系统 · <span className="text-cyan-300">柳州站</span>
                  </span>
                </motion.div>
              ...
              {/* 右侧：柳州站主理人形象（CSS 渐变 + 文字占位，无需图片资源）*/}
              <motion.div
              ...
              >
                <div className="relative w-full aspect-square max-w-sm">
                  ...
                  >
                    <Image
                      src="/images/liuzhou.png"
                      alt="柳州主理人 - 良朋社OPC 城市合伙人"
                      width={400}
                      height={400}
                      priority
                      quality={95}
        ...
        <section className="relative -mt-10 px-5 z-10">
          <div className="max-w-lg mx-auto md:max-w-6xl md:mx-auto">
            <ActivityTicker activities={LiuzhouStaticActivities} />
          </div>
        </section>
              ...
              <div className="relative flex items-center gap-5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm md:text-base text-white/90 leading-relaxed">
                    全国 7 座城市已联动（含柳州），招募更多城市合伙人共拓 AI 市场
                  </p>
          ...
          <div className="max-w-lg mx-auto md:max-w-6xl md:mx-auto">
            <div className="relative bg-gradient-to-br from-cyan-600/90 via-blue-600/90 to-violet-700/90 backdrop-blur-md border border-white/20 rounded-3xl p-8 overflow-hidden">
              ...
              <div className="relative text-center">
                <h3 className="text-xl font-bold text-white mb-3">加入柳州站 · 良朋社OPC</h3>
